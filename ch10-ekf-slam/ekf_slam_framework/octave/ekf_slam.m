...
% Initialize belief:
% mu: (2N + 3) x 1 vector representing the mean of the normal distribution
...
mu = zeros(2*N + 3, 1);
robSigma = zeros(3);  % cov. of robot pose
robMapSigma = zeros(3, 2*N);  % cov. of robot pose connected with map
mapSigma = INF*eye(2*N);  % cov. of map
